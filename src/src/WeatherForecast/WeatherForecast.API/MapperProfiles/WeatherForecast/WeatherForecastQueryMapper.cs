...
[Mapper]
public partial class WeatherForecastQueryMapper
{
    public partial WeatherForecastResponse WeatherForecastQueryAllToResponse(WeatherForecastQueryAllResponse weatherForecastQueryAll);
}
