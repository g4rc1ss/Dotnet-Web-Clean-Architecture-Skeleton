...
[Mapper]
public partial class WeatherForecastCreateMapper
{
    ...
    public partial WeatherForecastCommandCreateRequest WeatherForecastRequestToCommandRequest(CreateWeatherForecastRequest createWeatherForecast);
}
